test_that("as.expression handling; lhs of theta parameters", {
  ...
  expect_equal(
    .lotriGetEtaMatrixElementsPlusForm(x1),
    list(
      quote(et5 ~ 1),
  ...
  expect_equal(
    .lotriGetEtaMatrixElementsLineForm(x1),
    list(
      quote(et5 ~ 1),
      quote(label("eta 5")),
      quote(et2 ~ 1),
  ...
  expect_equal(
    .lotriGetEtaMatrixElementsPlusForm(fix2),
    list(
      quote(m + n ~ c(2, 0.5, 1)),
  ...
  expect_equal(
    .lotriGetEtaMatrixElementsLineForm(fix2),
    list(
      quote(m ~ 2),
      quote(n ~ c(0.5, 1)),
      quote(f ~ fix(1) | occ),
